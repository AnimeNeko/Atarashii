...
public class MALManager {
    ...
    public HashMap<String, Object> getRecordDataFromJSONObject(JSONObject jsonObject, String type) {
        ...
        try {
        	if (type.equals(TYPE_ANIME)|| type.equals(TYPE_MANGA)) {
    			...
    			recordData.put("anime_time_days_d", anime.getDouble("time_days"));
    			...
    			recordData.put("manga_time_days_d", manga.getDouble("time_days"));
    ...
    public void downloadAndStoreProfile(String user) {
        ...
        try {
            ...
            HashMap<String, Object> recordData = getRecordDataFromJSONObject(jsonObject, "profile");
    ...
    public void downloadAndStoreFriends(String user) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
            	HashMap<String, Object> recordData = getRecordDataFromJSONObject(jArray.getJSONObject(i), "friends");
