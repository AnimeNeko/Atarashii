...
public class RatingPickerDialogFragment extends SherlockDialogFragment
		implements SlidingRatingBar.IUpdateRatingText {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		view = View.inflate(new ContextThemeWrapper(getActivity(),
				R.style.AlertDialog), R.layout.dialog_rating_picker, null);
		...
		builder.setPositiveButton("Update",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int whichButton) {
						((DetailView) getActivity())
								.onRatingDialogDismissed(rating);
						dismiss();
					}
				})
				...
				.setView(view)
				.setTitle(
						getResources().getString(R.string.dialog_title_rating));
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		RatingBar = (SlidingRatingBar) view
				.findViewById(R.id.dialogMyRatingBar);
