...
public class FirstTimeInit extends SherlockActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		registerButton.setOnClickListener(new OnClickListener() {
			public void onClick(View arg0) {
				Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri
						.parse("http://myanimelist.net/register.php"));
		...
		messenger = new Handler() {
			...
			public void handleMessage(Message msg) {
				if (msg.what == 2) {
					pd.dismiss();
					Crouton.makeText(FirstTimeInit.this,
							R.string.crouton_error_VerifyProblem, Style.ALERT)
							.show();
				}
				if (msg.what == 3) {
					pd.dismiss();
	...
	private void tryConnection() {
		pd = ProgressDialog.show(this,
				context.getString(R.string.dialog_title_Verifying),
				context.getString(R.string.dialog_message_Verifying));
