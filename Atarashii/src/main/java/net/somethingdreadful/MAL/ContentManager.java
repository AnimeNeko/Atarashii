...
public class ContentManager {
    ...
    public ContentManager(Context context) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.ContentManager(context)");
    ...
    public ContentManager(Activity activity) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.ContentManager(activity)");
        if (AccountService.isMAL())
    ...
    public Anime getAnime(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getAnime(): id=" + id);
        return dbMan.getAnime(id);
    }

    public Manga getManga(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getManga(): id=" + id);
        return dbMan.getManga(id);
    }

    public ArrayList<Anime> downloadAnimeList(String username) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.downloadAnimeList(): username=" + username);
    ...
    public ArrayList<Manga> downloadMangaList(String username) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.downloadMangaList(): username=" + username);
    ...
    public ArrayList<Anime> getAnimeListFromDB(String ListType, int sortType, String inverse) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getAnimeListFromDB(): listType=" + ListType + " sortType=" + sortType + " inverse=" + inverse);
    ...
    public ArrayList<Manga> getMangaListFromDB(String ListType, int sortType, String inverse) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMangaListFromDB(): listType=" + ListType + " sortType=" + sortType + " inverse=" + inverse);
        return dbMan.getMangaList(ListType, sortType, inverse.equals("false") ? 1 : 2);
    }

    public Manga updateWithDetails(int id, Manga manga) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.updateWithDetails(): id=" + id);
    ...
    public ArrayList<Profile> downloadAndStoreFriendList(String user) {
        ...
        try {
            Theme.log(Log.INFO, "Atarashii", "ContentManager.downloadAndStoreFriendList(): username=" + user);
            ...
            Theme.log(Log.ERROR, "Atarashii", "ContentManager.downloadAndStoreFriendList(): " + e.getMessage());
    ...
    public ArrayList<Profile> getFollowers(String user) {
        ArrayList<Profile> result = new ArrayList<>();
        try {
            Theme.log(Log.INFO, "Atarashii", "ContentManager.getFollowers(): username=" + user);
            result = alApi.getFollowers(user);
        } catch (Exception e) {
            Theme.log(Log.ERROR, "Atarashii", "ContentManager.getFollowers(): " + e.getMessage());
            Theme.logException(e);
        }
    ...
    public ArrayList<Profile> getFriendListFromDB() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getFriendListFromDB()");
    ...
    public Profile getProfile(String name) {
        ...
        try {
            Theme.log(Log.INFO, "Atarashii", "ContentManager.getProfile(): username=" + name);
            ...
            Theme.log(Log.ERROR, "Atarashii", "ContentManager.getProfile(): " + e.getMessage());
            Theme.logException(e);
        }
        return profile;
    }
    ...
    public Profile getProfileFromDB() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getProfileFromDB()");
        return dbMan.getProfile();
    }

    public void saveAnimeToDatabase(Anime anime) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.saveAnimeToDatabase(): id=" + anime.getId());
        dbMan.saveAnime(anime);
    }

    public void saveMangaToDatabase(Manga manga) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.saveMangaToDatabase(): id=" + manga.getId());
    ...
    public void cleanDirtyAnimeRecords() {
        ...
        if (dirtyAnimes != null) {
            Theme.log(Log.INFO, "Atarashii", "ContentManager.cleanDirtyAnimeRecords(): size=" + dirtyAnimes.size());
            ...
            for (Anime anime : dirtyAnimes) {
                if (writeAnimeDetails(anime)) {
                    ...
                    Theme.log(Log.ERROR, "Atarashii", "ContentManager.cleanDirtyAnimeRecords(): Failed to update " + anime.getId());
                }
            }
            Theme.log(Log.INFO, "Atarashii", "ContentManager.cleanDirtyAnimeRecords()");
        }
    }
    ...
    public void cleanDirtyMangaRecords() {
        ...
        if (dirtyMangas != null) {
            Theme.log(Log.INFO, "Atarashii", "ContentManager.cleanDirtyMangaRecords(): size=" + dirtyMangas.size());
            ...
            for (Manga manga : dirtyMangas) {
                if (writeMangaDetails(manga)) {
                    ...
                    Theme.log(Log.ERROR, "Atarashii", "ContentManager.cleanDirtyMangaRecords(): Failed to update " + manga.getId() + ".");
                }
            }
            Theme.log(Log.INFO, "Atarashii", "ContentManager.cleanDirtyMangaRecords()");
        }
    }
    ...
    public ArrayList<History> getActivity(String username, int page) {
        ...
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getActivity(): got " + String.valueOf(result != null ? result.size() : 0) + " records on " + page);
        return result;
    }
    ...
    public Anime getAnimeRecord(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getAnimeRecord(): id=" + id);
        return AccountService.isMAL() ? malApi.getAnime(id, 0) : alApi.getAnime(id);
    }

    public Manga getMangaRecord(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMangaRecord(): id=" + id);
        return AccountService.isMAL() ? malApi.getManga(id, 0) : alApi.getManga(id);
    }

    public void verifyAuthentication() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.verifyAuthentication()");
        if (AccountService.isMAL())
            malApi.isAuth();
    ...
    public boolean writeAnimeDetails(Anime anime) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.writeAnimeDetails(): id=" + anime.getId());
        boolean result;
        ...
        Theme.log(result ? Log.INFO : Log.ERROR, "Atarashii", "ContentManager.writeAnimeDetails(): successfully=" + result);
        return result;
    }

    public boolean writeMangaDetails(Manga manga) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.writeMangaDetails(): id=" + manga.getId());
        boolean result;
        ...
        Theme.log(result ? Log.INFO : Log.ERROR, "Atarashii", "ContentManager.writeMangaDetails(): successfully=" + result);
        return result;
    }

    public ArrayList<Anime> getMostPopularAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMostPopularAnime(): page=" + page);
    ...
    public ArrayList<Manga> getMostPopularManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMostPopularManga(): page=" + page);
    ...
    public ArrayList<Anime> getTopRatedAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopRatedAnime(): page=" + page);
    ...
    public ArrayList<Manga> getTopRatedManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopRatedManga(): page=" + page);
    ...
    public ArrayList<Anime> getJustAddedAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getJustAddedAnime(): page=" + page);
    ...
    public ArrayList<Manga> getJustAddedManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getJustAddedManga(): page=" + page);
    ...
    public ArrayList<Anime> getUpcomingAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getUpcomingAnime(): page=" + page);
    ...
    public ArrayList<Manga> getUpcomingManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getUpcomingManga(): page=" + page);
    ...
    public ArrayList<Anime> searchAnime(String query, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.searchAnime(): page=" + page + " query=" + query);
    ...
    public ArrayList<Manga> searchManga(String query, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.searchManga(): page=" + page + " query=" + query);
    ...
    public ArrayList<Reviews> getAnimeReviews(int id, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getAnimeReviews(): page=" + page + " id=" + id);
    ...
    public ArrayList<Reviews> getMangaReviews(int id, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMangaReviews(): page=" + page + " id=" + id);
    ...
    public ArrayList<Forum> getForumCategories() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getForumCategories()");
    ...
    public ArrayList<Forum> getCategoryTopics(int id, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getCategoryTopics(): page=" + page + " id=" + id);
    ...
    public ArrayList<Forum> getTopic(int id, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopic(): page=" + page + " id=" + id);
        return AccountService.isMAL() ? malApi.getPosts(id, page).createBaseModel() : alApi.getPosts(id, page).convertBaseModel();
    }

    public void deleteAnime(Anime anime) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.deleteAnime(): id=" + anime.getId());
        dbMan.deleteAnime(anime.getId());
    }

    public void deleteManga(Manga manga) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.deleteManga(): id=" + manga.getId());
        dbMan.deleteManga(manga.getId());
    }

    public ArrayList<Forum> search(String query) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.search(): query=" + query);
    ...
    public ArrayList<Forum> getSubCategory(int id, int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getSubCategory(): page=" + page + " id=" + id);
        return malApi.getSubBoards(id, page).createBaseModel();
    }

    public boolean addComment(int id, String message) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.addComment(): message=" + message + " id=" + id);
    ...
    public boolean updateComment(int id, String message) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.updateComment(): message=" + message + " id=" + id);
    ...
    public ArrayList<Recommendations> getAnimeRecs(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getAnimeRecs(): id=" + id);
        return malApi.getAnimeRecs(id);
    }

    public ArrayList<Recommendations> getMangaRecs(int id) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getMangaRecs(): id=" + id);
        return malApi.getMangaRecs(id);
    }

    public Schedule getSchedule() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getSchedule()");
        return AccountService.isMAL() ? malApi.getSchedule() : alApi.getSchedule();
    }

    public void saveSchedule(Schedule schedule) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.saveSchedule()");
        dbMan.saveSchedule(schedule);
    }

    public Schedule getScheduleFromDB() {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getScheduleFromDB()");
        return dbMan.getSchedule();
    }

    public ArrayList<Anime>  getPopularSeasonAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getPopularSeasonAnime(): page=" + page);
    ...
    public ArrayList<Anime>  getPopularYearAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getPopularYearAnime(): page=" + page);
    ...
    public ArrayList<Anime>  getTopSeasonAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopSeasonAnime(): page=" + page);
    ...
    public ArrayList<Anime>  getTopYearAnime(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopYearAnime(): page=" + page);
    ...
    public ArrayList<Manga>  getPopularSeasonManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getPopularSeasonManga(): page=" + page);
    ...
    public ArrayList<Manga> getPopularYearManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getPopularYearManga(): page=" + page);
    ...
    public ArrayList<Manga> getTopSeasonManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopSeasonManga(): page=" + page);
    ...
    public ArrayList<Manga> getTopYearManga(int page) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getTopYearManga(): page=" + page);
    ...
    public ArrayList<Anime> getBrowseAnime(Map<String, String> queries) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getBrowseAnime(): queries=" + queries.toString());
    ...
    public ArrayList<Manga> getBrowseManga(Map<String, String> queries) {
        Theme.log(Log.INFO, "Atarashii", "ContentManager.getBrowseManga(): queries=" + queries.toString());
