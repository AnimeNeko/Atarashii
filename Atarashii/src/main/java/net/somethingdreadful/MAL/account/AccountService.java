...
public class AccountService extends Service {
    public static net.somethingdreadful.MAL.account.AccountType accountType;
     ...
     */
    private static net.somethingdreadful.MAL.account.AccountType getAccountType(String type) {
        if (net.somethingdreadful.MAL.account.AccountType.AniList.toString().equals(type))
            return AniList;
        else
            return MyAnimeList;
    }
     ...
     */
    public static void addAccount(String username, String password, net.somethingdreadful.MAL.account.AccountType accountType) {
        AccountManager accountManager = AccountManager.get(context);
